<template>
  <div class="search">
    ...
    >
      <el-form-item prop="searchTitle">
        <el-input v-model="state.form.searchTitle" placeholder="文章名称"/>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" :icon="Search" @click="methods.handleCurrentChange(1)">查询</el-button>
        <el-button type="primary" :icon="Refresh" @click="state.form.searchTitle=''">重置</el-button>
      </el-form-item>
    </el-form>
  </div>
  <div class="flex dialog">
    <el-button type="primary" :icon="Plus" @click="methods.openLink('add')">新建</el-button>
    <el-button type="danger" :icon="Delete" @click="methods.delete(true)">删除</el-button>
    <el-button type="success" :icon="Document" @click="router.replace({path:'/article/drafts'})">草稿箱</el-button>
  </div>
  <div class="table">
    ...
    >
      ...
      <el-table-column prop="title" label="文章标题" width="200px" show-overflow-tooltip/>
      <el-table-column prop="category" sortable label="文章分类" width="125px" show-overflow-tooltip/>
      <el-table-column prop="author" label="作者"/>
      <el-table-column prop="page_views" sortable label="浏览量"/>
      <el-table-column prop="commentCount" sortable label="评论数量"/>
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button type="primary" :icon="Edit" @click="methods.openLink('update',scope.row.id)"/>
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      rules: {
        searchTitle: [
          {min: 1, max: 255, message: '文章名称错误', trigger: 'blur'}
        ],
        content:[
